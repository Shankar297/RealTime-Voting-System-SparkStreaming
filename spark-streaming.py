...
def get_spark_session():
    spark = (SparkSession.builder
             .appName("ElectionVoting")
             .master("local[*]")
             .config("spark.jars.packages", "org.apache.spark:spark-sql-kafka-0-10_2.12:3.5.1")
             .config("spark.jars",
                     r"C:\Users\SynergicLinks03\Desktop\UNO-BANK\RealtimeVotingSystem\postgres-jar\postgresql-42.7.4.jar")  # PostgreSQL driver
...
def main():
    ...
    print('sending_to_kafka')
    votes_per_candidate_to_kafka = votes_per_candidate.selectExpr("to_json(struct(*)) as value")\
        .writeStream \
        .format("kafka") \
        .option("kafka.bootstrap.servers", "localhost:9092") \
        .option("topic", "aggregated_votes_per_candidate") \
        .option("checkpointLocation", r"C:\Users\SynergicLinks03\Desktop\UNO-BANK\RealtimeVotingSystem\checkpoints") \
        .outputMode("update") \
        .start()
